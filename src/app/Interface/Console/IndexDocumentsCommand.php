...
use App\Application\Ai\Knowledge\UseCase\IndexDocumentUseCase;
...
final class IndexDocumentsCommand extends Command
{
    ...
    public function handle(IndexDocumentUseCase $useCase): int
    {
        ...
        foreach ($files as $file) {
            ...
            try {
                ...
                $useCase->execute(new IndexDocumentInput(
                    content: $content,
                    metadata: [
