...
namespace App\Application\Ai\Conversation\ExecuteStep;
...
final readonly class ExecuteStepAction
{
    ...
    public function handle(Conversation $conversation, PlanStep $step): void
    {
